...
export default function WorkspacePage() {
  ...
  const totalCards = boards.reduce((sum, b) => sum + getCardCount(b), 0);
      ...
      <div className="space-y-8">
        <div>
          ...
          <p className="text-secondary">
            Manage your workspace details and boards.
          </p>
        </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                  <div className="flex items-center gap-3 rounded-lg border border-gray-100 bg-surface p-4">
